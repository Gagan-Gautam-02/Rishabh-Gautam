...
export function UserDashboard() {
    ...
    processRazorpayPayment({
      ...
      onSuccess: async (rzpResult) => {
        try {
          ...
          toast.success("Payment successful! Your booking will be confirmed within 24 hours. 🙏");
          resetServiceRequest();
          setTab("status");
        } catch (err: unknown) {
          ...
          try {
            ...
            toast.success("Payment successful! Booking will be confirmed within 24 hours. 🙏");
            resetServiceRequest();
            setTab("status");
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-10">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-[var(--ink)]">
                          {b.brideName
                            ...
                            : b.serviceName?.startsWith("Yoga Course:")
                              ? `${b.serviceName}`
                              : b.serviceName
                        ...
                        <p className="mt-1 text-sm text-[var(--faint)]">
                          {b.brideName
                            ...
                            : b.serviceName?.startsWith("Yoga Course:")
                              ? `Plan: ${b.timeSlot} · Enrolled by ${b.userName} · Paid: ₹${b.amount}`
                              : b.serviceName
      ...
      {/* ── WhatsApp Help & Support (always visible) ── */}
      <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 p-5 sm:p-6 rounded-2xl border"
        style={{ background: "rgba(37,211,102,0.04)", borderColor: "rgba(37,211,102,0.25)" }}>
        <div>
          <h3 className="font-semibold text-[var(--ink)] mb-1 text-sm sm:text-base">
            Need Help or Have a Query?
          </h3>
          <p className="text-xs sm:text-sm" style={{ color: "var(--cream-muted)" }}>
            Contact us directly on WhatsApp for instant support, guidance, or booking help.
          </p>
        </div>
        <a
          href="https://wa.me/917300530090"
          target="_blank"
          rel="noopener noreferrer"
