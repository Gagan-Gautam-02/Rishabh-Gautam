export const en = {
  ...
  landing: {
    ...
    bookSession: "Book a Consultancy",
  ...
  footer: {
    blurb:
      "Personalized yoga and astrology consultations at Shastriya Yogshala. 100% confidential guidance for yoga practice, Jyotish, and spiritual wellbeing.",
    contact: "Contact",
  ...
  auth: {
    ...
    signupSub: "Join {name} to book a consultancy",
    fullName: "Full Name",
    phone: "Phone Number",
    city: "City",
    signup: "Sign Up",
  ...
  dashboard: {
    ...
    bookASession: "Book a consultancy",
    myBookings: "My bookings",
    noBookings: "No bookings yet",
    noBookingsHint: "Request an astrology consultation to get started.",
    pending: "Pending",
    confirmed: "Confirmed",
    rejected: "Rejected",
    chat: "Chat",
